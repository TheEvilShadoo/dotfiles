...
manage(Window w, XWindowAttributes *wa)
{
	...
	if (getatomprop(c, netatom[NetWMWindowType]) == netatom[NetWMWindowTypeDesktop] || getatomprop(c, netatom[NetWMWindowType]) == netatom[NetWMWindowTypeDock]) {
		XMapWindow(dpy, c->win);
...
//        char *l = strchr(rawstext, statussep);
//		if (l) {
//			*l = '\0'; l++;
